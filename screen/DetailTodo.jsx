          ...
          <VStack space={2} px="3" py="3">
            <Box pt="2">
              <Text textAlign="justify">
                ...
                iure debitis consequatur. Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Maxime cumque, blanditiis commodi error
                recusandae magnam possimus nostrum eaque iste mollitia
                architecto ut totam, molestiae repudiandae vitae esse similique?
                Minima, perspiciatis!
              </Text>
            </Box>
            <Box py={4}>
